...
// import * as client from "../client"; // Importing the client to make API requests
// import { Question } from "./questionsReducer"; // Importing Question type from reducer
...
// import users from "../../../Database/users.json"; // Importing user data from JSON
// import "./index.css";
...
//     const userId = users[0]._id; // Assuming we take the first user for faculty preview

//     // Fetch existing quiz result from Redux
//     const selectedResult = useSelector((state: any) => state.quizResult.selectedResult);
...
//                                 {questionsList[currentQuestionIndex].type === "True False" && (
